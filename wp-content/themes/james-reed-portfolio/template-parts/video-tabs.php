...
<section class="video-tabs">
    <div class="row">
        ...
        <div class="more-videos col-xs-12">
            <a href="https://www.youtube.com/channel/UCScUiNVwSgZ8bt0lujsAjeA" class="btn btn-link text-right">View more videos  <i class="fa fa-external-link" aria-hidden="true"></i></a>
        </div>
    </div>
</section>
