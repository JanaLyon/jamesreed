...
<head>
    ...
    <link rel="icon" type="image/jpg" href="/wp-content/themes/james-reed-portfolio/img/reed-icon-57x57.jpg">
                ...
                <nav class="row">
                    <div class="col-xs-12">
                        <ul id="menu-top-menu" class="nav nav-custom navbar-nav menu">
                            <li class="menu-item">
                                <a class="logo"><img src="/wp-content/themes/james-reed-portfolio/img/reedlogo.svg"
                                                     width="110px" height="auto" alt="Reed logo"/></a>
                                <a class="logo-sm"><img
                                            src="/wp-content/themes/james-reed-portfolio/img/reed-r-logo.svg"
