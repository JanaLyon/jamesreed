            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="button-container text-center space-top-20">
                        <a class="btn-action" href="/james-reed/in-the-news-all-articles/">View all articles</a>
                    </div>
                </div><!-- .row -->
                <div class="row">
                    <section class="press-enquiries space-top-40">
                        <div class="col-xs-12 col-md-2">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/press-icon.svg" width="100px" height="auto" />
                            </div>
                        ...
                        <div class="col-xs-12 col-md-2">
                            <a href="https://www.reed.co.uk/press-office" class="btn-action">Press enquiries</a>
                        </div>
                    </section>
                </div><!-- .row -->
            </div><!-- .container -->
